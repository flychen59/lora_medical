...
model = PeftModel.from_pretrained(model, model_id="/root/autodl-tmp/output/Qwen2-NER/checkpoint-1700")
...
# model_dir = '/root/autodl-tmp/output/Qwen2-NER/checkpoint-1700'
