...
def process_func(example):
    ...
    system_prompt ="""你是一个医学实体识别领域的专家，你需要从给定的句子中提取中医治则 ,中医治疗 ,中医证候 ,中医诊断 ,中药 ,临床表现 ,其他治疗 ,方剂 ,西医治疗 ,西医诊断. 以 json 格式输出, 如 {"entity_text": "口苦", "entity_label": "临床表现"} 注意: 1. 输出的每一行都必须是正确的 json 字符串. 2. 找不到任何实体时, 输出"没有找到任何实体". """
...
model_dir ="/root/autodl-tmp/qwen/"
...
train_jsonl_new_path = "/root/autodl-tmp/data_process/medical.train4.json"
...
args = TrainingArguments(
    output_dir="./output/Qwen2-NER_medical_num50",
...
test_df = pd.read_json(train_jsonl_new_path, lines=True).sample(n=20)
